  ...
  return (
    <div className="px-5 pt-8 pb-32">
      ...
      <header className="mt-6">
        <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Étape 1 / 3</p>
        <h1 className="mt-2 font-display text-3xl">Type de document</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Choisissez le format que l'IA doit produire à partir de votre enregistrement.
        </p>
      </header>
      ...
      <div className="mt-8 space-y-3">
        ...
        >
          ...
          <div className="flex-1">
            <div className="font-display text-xl">Rapport</div>
            <div className="text-xs text-muted-foreground">
              Document narratif et analytique — observations terrain, constats, recommandations.
            </div>
          </div>
        ...
        >
          ...
          <div className="flex-1">
            <div className="font-display text-xl">PV simple</div>
            <div className="text-xs text-muted-foreground">
              Procès-verbal formel — faits, déclarations, conclusion. Style juridique sobre.
            </div>
          </div>
          <ChevronRight className="h-5 w-5 text-muted-foreground transition group-hover:text-gold" />
        </button>
